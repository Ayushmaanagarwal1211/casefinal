...
router.push('/')
  ...
  setbottom1(window.innerHeight-410)
    ...
    // useEffect(()=>{
    //   casedetails && (setdashboard(false) ||setseecase(false) || setaddcasetype(false) || setsettings(false) || settasks(false) || setappointement(false)||setaddclient(false)||setaddadvocate(false))
