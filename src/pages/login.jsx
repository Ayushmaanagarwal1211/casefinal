...
const [showerror,setshowerror]=useState(false)
  ...
  async function handleclicklogin(e){
   ...
   const data= await fetch(`api/${admin?'adminlogin':judge?'judgeogin':advocate?"advocatelogin":'clientlogin'}`,{
        method:"POST",
        body:JSON.stringify({
            email : admin?"admin@gmail.com":client?"client@gmail.com":advocate?"advocate@gmail.com":"judge@gmail.com",
            password:admin?"admin":client?"client":advocate?"advocate":"judge",
        })
    })
